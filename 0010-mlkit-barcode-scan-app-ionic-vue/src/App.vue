            ...
            <ion-menu content-id="main-content" type="overlay">
                <ion-content>
                    <ion-list id="inbox-list">
                        <ion-list-header>MLKitBarcode</ion-list-header>
                        <ion-note>Scan your barcode with MLKit</ion-note>
...
selectedIndex.value = appPages.findIndex((page) => {
    return page.title.toLowerCase() === window.location.pathname.substring(1)
});
</script>
